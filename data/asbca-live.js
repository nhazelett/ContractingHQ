window.KTHQ_ASBCA_DATA = {
  "generatedAt": "2026-06-26T10:41:00.520349+00:00",
  "source": {
  ...
  "items": [
    {
      "id": "2026-06-04-iva-al-solutions-llc-0",
    ...
    {
      "id": "2026-06-04-drs-laurel-technologies-2",
    ...
    {
      "id": "2026-06-04-akima-range-readiness-operations-llc-1",
    ...
    {
      "id": "2026-06-03-gilbane-smcc-ecc-llc-5",
    ...
    {
      "id": "2026-06-03-drs-laurel-technologies-3",
      "caseName": "DRS Laurel Technologies",
    ...
    {
      "id": "2026-06-03-asturian-consigli-jv-llc-4",
    ...
    {
      "id": "2026-06-02-j-a-m-construction-services-inc--6",
    ...
    {
      "id": "2026-06-01-puyenpa-services-llc-7",
    ...
    {
      "id": "2026-06-01-innosense-corporation-8",
    ...
    {
      "id": "2026-05-28-globe-trailer-manufacturing-inc--9",
    ...
    {
      "id": "2026-05-28-desbuild-incorporated-10",
    ...
    {
      "id": "2026-05-28-desbuild-incorporated-11",
      "caseName": "Desbuild Incorporated",
    ...
    {
      "id": "2026-05-28-desbuild-incorporated-12",
      "caseName": "Desbuild Incorporated",
    ...
    {
      "id": "2026-05-28-desbuild-incorporated-13",
      "caseName": "Desbuild Incorporated",
    ...
    {
      "id": "2026-05-27-kph-construction-corp--14",
    ...
    {
      "id": "2026-05-26-winn-solutions-llc-15",
    ...
    {
      "id": "2026-05-26-tanik-construction-company-inc--16",
    ...
    {
      "id": "2026-05-21-inland-service-corporation-llc-17",
      ...
      "judge": "Laufgraben",
      "officialExcerpt": "Because Inland's argument that the Army must choose a reasonable completion period fits more naturally with the implied duty of good faith > 4 Although Inland has not made the argument, we recognize that \"[w]hen the parties to a bargain sufficiently defined to be a contract have not agreed with respect to a term which is essential to a determination of their rights and duties, a term which is reasonable in the circumstances is supplied by the court.\" Rest. Inland Submits A Claim For Additional Costs Inland submitted a request for equitable adjustment (REA) to the Army on July 26, 2023, asserting that the Base...",
      "tags": [
        "Termination",
        "REA / changes",
        "Motions",
      ...
      "pdfUrl": "https://www.asbca.mil/LinkClick.aspx?fileticket=XiKrbagLjXU%3d&portalid=143",
      "filename": "LinkClick.aspx",
      "sourceStatus": "reader-extracted",
      "sourceStatusLabel": "ASBCA PDF text extracted",
      "sourceError": ""
