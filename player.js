...
(function () {
  ...
  var CCO_PAGE_FALLBACKS = [
    ...
    'ocs-for-dummies-part-2.html',
    'afcap.html',
    'afcap-volume-ii.html',
    'far-part-18-flexibilities.html',
    'sf44-purchases.html',
    'manual-contracts-deployed.html',
    'purchasing-food-water-contingency.html',
    'establishing-dodaacs.html',
    'miprs-deployed-environment.html',
    'foo-program.html',
    'stafford-act.html',
  ...
  function modeForPath(value) {
    // One playlist everywhere. CCO pages no longer swap to a separate field radio.
    return 'default';
  }
  ...
  function loadCcoOptIn() {
    // Retired opt-in. Every track ships in the one playlist now.
    return true;
  }
  ...
  function ccoToggleHtml(id, cls) {
    // Toggle retired: the playlist always contains every track.
    return '';
  ...
  function toggleDefaultCcoMusic() {
    // Retired. The playlist is no longer splittable, so this is a no-op.
    return;
    /* eslint-disable no-unreachable */
...
`;
  ...
  var SOFT_NAV_PAGES = [
    ...
    // Training landing branch pages (added with the training.html restructure, Aug 2026)
    'training-beginner.html',
